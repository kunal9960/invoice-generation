...
for filepath in filepaths:
    ...
    pdf.set_font(family="Arial", size=16, style="B")    # Add dynamic invoice
    pdf.cell(w=50, h=8, txt=f"Invoice number: {invoice}", ln=1)

    pdf.set_font(family="Arial", size=16, style="B")    # Add dynamic date
    ...
    pdf.set_font(family="Arial", size=15, style="B")
    pdf.cell(w=25, h=8, txt=f"Dev Build")
    pdf.image("Dev.png", w=12)
